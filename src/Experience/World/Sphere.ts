...
export default class Sphere extends Shape {
  ...
  initInstance() {
    this.instance.position.x =
      this.parent.positions.x +
      Math.floor(Math.random() * this.parent.sizes.x) -
      this.parent.sizes.x / 2;
    this.instance.position.y =
      this.parent.positions.y +
      Math.floor(Math.random() * this.parent.sizes.y) -
      this.parent.sizes.y / 2;
    this.instance.position.z =
      this.parent.positions.z +
      Math.floor(Math.random() * this.parent.sizes.z) -
      this.parent.sizes.z / 2;
  }
  ...
  override accept(visitor: Visitor) {
    console.log('Accept Visitor from Sphere');
